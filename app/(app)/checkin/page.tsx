  ...
  return (
    <div className="flex flex-col gap-4">
      <p className="text-slate-500 text-sm leading-relaxed">
        Расскажи своими словами — что сейчас происходит в твоей жизни? Что тебя беспокоит, что радует, что давит? Это увидит только твой AI-ассистент и поможет подготовиться к разговору со специалистом.
      </p>
      <textarea
        value={form.freeText}
