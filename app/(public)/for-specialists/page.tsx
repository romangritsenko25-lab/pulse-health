    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="py-20 px-4 text-center bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-2xl mx-auto">
          <p className="text-xs font-bold text-blue-600 uppercase tracking-widest mb-4">Для специалистов</p>
          ...
          <Link
            ...
            className="inline-flex items-center px-7 py-4 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-2xl transition shadow-lg shadow-blue-200 text-sm"
          >
      ...
      {/* Quote */}
      <section className="py-16 px-4">
        <div className="max-w-lg mx-auto bg-blue-50 border border-blue-100 rounded-3xl p-8 text-center">
      ...
      <section className="py-16 px-4 text-center">
        <div className="max-w-md mx-auto flex flex-col items-center gap-5">
          ...
          <Link
            href="/specialist/register"
            className="w-full flex items-center justify-center py-4 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-2xl transition text-sm"
          >
            Создать профиль специалиста
          </Link>
          <Link href="/specialists" className="text-slate-400 hover:text-blue-600 text-xs transition">
